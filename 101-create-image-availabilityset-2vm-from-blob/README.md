# Very simple deployment, which creates an Image from a generalized (syspreped) blob and then an Availability Set with 2 VMs using Azure Managed Disks, created from that Image.  
